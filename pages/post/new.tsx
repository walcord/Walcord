...
export default function NewPostPage() {
  ...
  const mergeFiles = (prev: FileList | null, incoming: FileList | null) => {
    ...
    [...a, ...b].forEach((f) => map.set(`${f.name}-${f.size}-${f.lastModified}`, f));
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Banner h-24 SIN logo + botón volver */}
      ...
      {/* CONTENIDO en CAJA centrada (no ocupa toda la pantalla en app) */}
      <main className="mx-auto w-full max-w-[760px] px-4 sm:px-6 py-6 sm:py-8">
        <div className="rounded-2xl border border-neutral-200 bg-white shadow-[0_6px_22px_rgba(0,0,0,0.06)]">
          ...
          {/* Layout 2 columnas (en móvil una) */}
