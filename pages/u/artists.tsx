// pages/u/[username]/favourite-artists.tsx
'use client';

import { useEffect, useState } from 'react';
import { useRouter } from 'next/router';
import FavouriteArtistsViewer from '../u/FavouriteArtistsViewer';
import Image from 'next/image';
import { supabase } from '../../lib/supabaseClient';

export default function PublicArtistsWrapper() {
  ...
  return <FavouriteArtistsViewer viewerId={uid} />;
}
