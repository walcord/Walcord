// pages/u/[username]/favourite-songs.tsx
'use client';

import { useEffect, useState } from 'react';
import { useRouter } from 'next/router';
import FavouriteSongsViewer from '../u/FavouriteSongsViewer';
import Image from 'next/image';
import { supabase } from '../../lib/supabaseClient';

export default function PublicSongsWrapper() {
  ...
  return <FavouriteSongsViewer viewerId={uid} />;
}
